...
{
    public class PatcherMedian : MonoBehaviour {
        ...
        void Start() {
            ...
            patch_mat = new Material(Shader.Find("Hidden/MedianFilter"));
        ...
        private void InitShader() {
            ...
            patch_mat.SetVector("_MainTex_TexelSize", new Vector4(1.0f/width, 1.0f/height));
            patch_mat.SetVector("_Offsets", Vector4.zero);
            patch_mat.SetTexture("_Mask", mask);
        }
